...
public class DropsPageLocators {
    ...
    public static By moreFiltersText=By.xpath("//button[text()='More filters']");
    public static By morefilters = By.cssSelector(".filtersbutton");
    public static By metalPuritytext=By.xpath("//div[text()='Metal Purity']");
    ...
    public static By purityText=By.xpath("//span[text()='22 kt']");

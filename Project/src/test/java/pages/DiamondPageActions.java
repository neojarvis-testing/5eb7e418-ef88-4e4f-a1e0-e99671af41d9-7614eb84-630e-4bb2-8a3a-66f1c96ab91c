...
public class DiamondPageActions {
        ...
        switch (element) {
            ...
            case "New Arrivals":
                try {
                    ...
                    Reporter.addScreenshotToReport("ClickNewarrivalsFailure", test, "ClickNewarrivalsFailure",
                            Base.driver);
                    break;
                }
            case "First Product":
                try {
                    ...
                    Reporter.addScreenshotToReport("ClickFirstProductFailure", test, "ClickFirstProductFailure",
                            Base.driver);
                    break;
                }
            case "Add to cart":
        ...
        switch (element) {
            ...
            case "Popularity":
                try {
                    ...
                    Reporter.addScreenshotToReport("HoverPopularityFailure", test, "HoverPopularityFailure",
                            Base.driver);
                    break;
                }
        }
     ...
     * Author Name: Tapaswini
     * Description: This method verifies if a dropdown is expanded
     * Return Type: void
     * Parameter List: String string
     */

    public void isExpanded(String string) {
        switch (string) {
            case "Gender":
                webDriverHelper.waitForTheElementToBeVisible(diamondEarrings.womenDiamond, 10);
                assertion.verifyText(diamondEarrings.womenDiamond, "Women");
        }
    }
    ...
    public void isDisplayed(String string) {
        switch (string) {
            case "METAL":
                assertion.verifyText(diamondEarrings.metals, "METAL");
                break;
            case "Women":
                webDriverHelper.waitForTheElementToBeVisible(diamondEarrings.womentResultText, 10);
                assertion.verifyText(diamondEarrings.womentResultText, "Women");
                break;
            case "New Arrivals":
                assertion.verifyText(diamondEarrings.newArrivals, "New Arrivals");
                break;
    ...
    /*
     * Method Name: isFilterApplied
     * Author Name: Tapaswini
     * Description: This method verifies if a filter is applied
     * Return Type: void
     * Parameter List: String string
     */
    public void isFilterApplied(String string) {
        switch (string) {
            case "New Arrivals":
                assertion.verifyText(diamondEarrings.popularityButton, "New Arrivals");
        }
    }

...
public class DropPageStepDefinitions {
    ExtentTest test=Hooks.reports.createTest("Drops Module TC_06");
    DropPageActions actions=new DropPageActions(test);
...
@Then("user3 verifies text {string} for filter")
public void user3_verifies_text_for_filter(String string) {
    actions.verificationMethod(string);
}
...
@When("the user3 verifies text {string} under MoreFilters")
public void the_user3_verifies_text_under_more_filters(String string) {
    actions.verificationMethod(string);
}
...
@When("user verifies the text {string} under Metalpurity")
public void user_verifies_the_text_under_metalpurity(String string) {
    actions.verificationMethod(string);
}

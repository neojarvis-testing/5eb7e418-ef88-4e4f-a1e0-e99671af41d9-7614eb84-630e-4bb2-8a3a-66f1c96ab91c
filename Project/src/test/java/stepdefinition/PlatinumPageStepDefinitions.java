...
public class PlatinumPageStepDefinitions {
    ExtentTest test = Hooks.reports.createTest("Platinum Module TC_07");
    PlatinumPageActions actions = new PlatinumPageActions(test);
    ...
    @When("the user verifies the filter text {string}")
    public void the_user_verifies_the_filter_text(String string) {
        actions.verifyMethod(string);
    }
    ...
    @When("user3 verifies available text {string}")
    public void user3_verifies_available_text(String string) {
        actions.verifyMethod(string);
    }
    ...
    @When("user3 verifies the yes text {string}")
    public void user3_verifies_the_yes_text(String string) {
        actions.verifyMethod(string);
    }
